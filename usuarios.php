            ...
            <div class="table-responsive-sm">
                ...
                <nav aria-label="...">
                    <ul class="pagination p-4 pagination-sm d-flex justify-content-center flex-wrap">
                        <li class="page-item ">
                            <a class="page-link" href="usuarios.php?pagina=<?php echo 1 ?>">Primeira</a>
                        </li>
                        <?php
                        ...
                        ?>
                            <li <?php echo $estilo ?>><a class="page-link " href="usuarios.php?pagina=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php    } ?>
                        <li class="page-item">
                            <a class="page-link" href="usuarios.php?pagina=<?php echo $num_paginas ?>">Última</a>
                        </li>
                    </ul>
                </nav>
            </div>
