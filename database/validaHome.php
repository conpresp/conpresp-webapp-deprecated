...
<font face="arial" color="black" size="4">
  ...
  if (!mysqli_set_charset($conecta, "utf8mb4")) {
    ...
    if (isset($_FILES['documentacaoFotografica']) && isset($_FILES['documentacaoGrafica'])) {
      if ($_FILES['documentacaoFotografica']['size'] <= 2097152 && $_FILES['documentacaoGrafica']['size'] <= 2097152) {
        ...
        if ($extensao == '.PNG' || $extensao == '.png' || $extensao == '.JPG' || $extensao == '.jpg' || $extensao == '.JPEG' || $extensao == '.jpeg') {
          ...
          $diretorio2 = '../imgGrafica/img1/';
          
          move_uploaded_file($_FILES['documentacaoFotografica']['tmp_name'], $diretorio . $documentacaoFotografica);
          move_uploaded_file($_FILES['documentacaoGrafica']['tmp_name'], $diretorio2 . $documentacaoGrafica);
